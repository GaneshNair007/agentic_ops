...
export const ProblemStatement: React.FC = () => {
  return (
    <section className="w-full min-h-[80vh] bg-[#F3F1EC] text-[#090909] py-[96px] px-6 md:px-12 border-b border-[#D8D6D0] flex flex-col justify-center">
      <div className="w-full max-w-[1760px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="pt-4 border-t border-[#D8D6D0] flex gap-8 text-sm font-mono text-[#686868] uppercase">
        ...
        <div className="lg:col-span-5 relative">
          ...
          <div className="absolute -bottom-4 -left-4 bg-[#090909] text-[#F3F1EC] p-4 text-[12px] font-mono uppercase tracking-widest border border-[#D8D6D0]">
